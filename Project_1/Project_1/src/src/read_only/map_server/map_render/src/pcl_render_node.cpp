...
void rcvGlobalPointCloudCallBack(const sensor_msgs::PointCloud2 &pointcloud_map)
{
    ...
    pcl::fromROSMsg(pointcloud_map, cloud_new);
    
    // Replace cloud_input with new cloud (avoid accumulation, support dynamic obstacles)
    cloud_input = cloud_new;
    
    // Update kdtree with new cloud
